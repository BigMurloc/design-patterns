 ...
 * It declares prototype interface with method clone() which is implemented by concrete class and its subclasses <p></p>
 ...
 * e.g. commonly used configuration - we can keep it in some kind of registry and call for prototype and then apply proper changes
 */
package prototype;