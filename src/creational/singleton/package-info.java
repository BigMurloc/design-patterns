 ...
 * <p>
 * - In a concurrent systems there is a risk of creating multiple creational.singleton objects thus breaking the contract
 * <p>
 * - If Singleton is mutable then the system may become unpredictable...
 * <p>
 * - Risk of abusing pattern in scenarios that does not need to be creational.singleton, later on causing pricey refactor
 * <p>
